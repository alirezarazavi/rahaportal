...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sEmptyTable": "<p class='text-center'>اطلاعاتی برای نمایش وجود ندارد.</p>",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(جستجو شده از بین _MAX_ تعداد رکورد)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "رکوردی برای نمایش پیدا نشد."
		},
